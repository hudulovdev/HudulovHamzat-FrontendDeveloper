          ...
          <div className="mb-6 md:mb-0 flex flex-row gap-x-2">
            <a href="https://1spacex.com/" className="flex items-center">
              <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white font-space">
                SpaceX App (for BrainStorm Force)
              </span>
            </a>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">
                Used Tools for making this App
              </h2>
            ...
            <div>
              ...
              <ul className="text-gray-600 dark:text-gray-400">
                <li className="mb-4">
                  <a
                    href="https://github.com/hudulovdev/HudulovHamzat-FrontendDeveloper"
                    className="hover:underline"
                    target="_blank"
                    rel="noreferrer"
                  >
                ...
                <li className="mb-4">
                  <a
                    href="https://github.com/hudulovdev/HudulovHamzat-FrontendDeveloper/issues"
                    className="hover:underline"
                    target="_blank"
                    rel="noreferrer"
                  >
                ...
                <li className="mb-4">
                  <a
                    href="https://github.com/hudulovdev/HudulovHamzat-FrontendDeveloper/pulls"
                    className="hover:underline"
                    target="_blank"
                    rel="noreferrer"
                  >
